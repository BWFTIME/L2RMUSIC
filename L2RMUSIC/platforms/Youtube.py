...
# --- CONFIG (environment variables overrides) ---
...
# Allow user to override fallback API via env
...
async def load_api_url():
    """Load fallback API URL – first from env, then from Pastebin."""
    global YOUR_API_URL
...
class YouTubeAPI:
    ...
    async def _download_with_ytdlp(self, vid_id: str, is_video: bool, title: str) -> Optional[str]:
        ...
        clients_to_try = [
            ...
            {'use_cookies': False, 'client': 'android'},   # try without cookies as last resort
            ...
            opts = {
                ...
                'extractor_args': {
                    'youtube': {
                        ...
                        'skip': ['dash', 'hls'],   # avoid formats that may need extra auth
                    }
                }
            }
